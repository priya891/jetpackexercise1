...
import com.example.jetpackexercise1.DB.DbSettings;
import com.example.jetpackexercise1.DB.FavouriteDbHelper;
...
import java.util.List;
    ...
    public class FavouritesViewModel extends AndroidViewModel {
        ...
        public FavouriteDbHelper mFavHelper;
        public MutableLiveData<List<Favourites>> mFavs;

       public  FavouritesViewModel(Application application) {
            super(application);
            mFavHelper = new FavouriteDbHelper(application);
        }
