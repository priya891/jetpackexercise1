...
public class MainActivity extends AppCompatActivity {
    ...
    public FavouritesViewModel mFavViewModel;
    public List<Favourites> mFav;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               final  EditText inname = new EditText(MainActivity.this);

                AlertDialog dialog = new AlertDialog.Builder(MainActivity.this)
                        .setTitle("New Employee")
                        .setMessage("Enter Name,phone_no and Email of employee")
                        .setView(inname)
                        ...
                        .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                String url = String.valueOf(inname.getText());
